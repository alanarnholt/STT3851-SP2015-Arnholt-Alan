...
\bibitem{JF11}
    ...
    and Prediction}, New York, New York, 2009.    
\bibitem{DE12}
Davison, E.L. and Jessica N. Eatman \emph{An Ecological Examination 
of North Carolina's Amendment One Vote to Ban Same Sex Marriage}, 
(In progress), 2013.
\bibitem{AL02}
    Andy Liaw and Matthew Wiener,
    \emph{Classification and Regression by \texttt{randomForest}}, 
    R News, \textbf{2}, 3, 2002, 18-22.    
\end{thebibliography}
\normalsize
\vspace{-1ex}
\vfill
