...
\begin{itemize}
\item First, highlight the titles you want to select in \href{https://www.zotero.org}{Zotero}.  
...
\bibliographystyle{jss}  % or chicago I like jss
